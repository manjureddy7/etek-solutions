...
function BigData() {
    return(
        <div className='services-root'>
            ...
            <p>
                As a result, an increasing number of businesses are rethinking their approach to traditional enterprise storage and architecture to harness the power of big data. This is where PTechCrew LLC’s big data services aim at.
            </p>
        </div>
    )
}
