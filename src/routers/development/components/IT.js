...
function IT() {
    return(
        <div className='services-root'>
            <p>
                Technology is constantly changing. But one thing that stays the same is our approach to finding quality candidates and companies the right IT opportunities.
            </p>
            <h2>
            </h2>
            <p>
